...
for i = 1:size(files,2)/25
    ...
    for j = 1:size(joints,1)/20
        ...
        zhead = round(joints((j-1)*20+20,3)*240/708);
	...
	% For each "bone"
	    ...
	    zpt1 = round(joints((j-1)*20+jointindex1(k),3)*240/708) - zdiff;
	    zpt2 = round(joints((j-1)*20+jointindex2(k),3)*240/708) - zdiff;
        ...
        % Write images
        imwrite(im320x240_yx,['320x240_yx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im160x120_yx,['160x120_yx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im80x60_yx,['80x60_yx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im40x30_yx,['40x30_yx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im20x15_yx,['20x15_yx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        
	imwrite(im320x240_yz,['320x240_yz_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im160x120_yz,['160x120_yz_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im80x60_yz,['80x60_yz_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im40x30_yz,['40x30_yz_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im20x15_yz,['20x15_yz_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);

        imwrite(im240x240_zx,['240x240_zx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im120x120_zx,['120x120_zx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im60x60_zx,['60x60_zx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im30x30_zx,['30x30_zx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
        imwrite(im15x15_zx,['15x15_zx_Skeleton_' vidIdentifier '_' sprintf('%.03d',j) '.png']);
    end
end
